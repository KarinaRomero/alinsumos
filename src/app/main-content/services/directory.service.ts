...
export class DirectoryService {
  ...
  private ventasEtchojoa = new ContactCard('Operaciones y ventas Etchojoa', null, 'supervisor.a4@alinsumos.com');
  private ventasCuliacan = new ContactCard('Operaciones y ventas Culiacán', null, 'ventasculiacan@alinsumos.com');
  private paraFinanciera = new ContactCard('Parafinanciera', '119', 'parafinanciera119@alinsumos.com',
    '120', 'parafinanciera120@alinsumos.com');
  ...
  private controlCalidadYBascula = new ContactCard('Control de Calidad/Báscula', '121', 'calidad121@alinsumos.com',
    '111', 'bascula111@alinsumos.com');
